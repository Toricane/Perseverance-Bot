...
help_dict_list = {
    "8ball" : ["Ask a question, and the bot tells your fortune.", "`/8ball question`\n`.8ball question`"],
    "addrole" : ["Add a role to a member.\nRequires Manage Roles permission.", "`/addrole @username @role`\n`.addrole @username @role`", "`.ar`"],
    "avatar" : ["View someone's profile picture", "`/avatar @username`\n`.avatar @username`", "`.pfp`"],
    ...
    "define" : ["Define any word in English.", "`/define word`\n`.define word`", "`.def`"],
    ...
    "inspire" : ["Gives a random inspirational quote.", "`/inspire`\n`.inspire`"],
    ...
    "run" : ["Run some code!\nRequires you to be Toricane#0818.", "`/run code`\n`.run code`"],
